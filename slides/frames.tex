    ...
    \begin{column}{0.95\textwidth}
      \begin{bluecolorbox}[Droplet interactions]
        ...
        \item Droplets in confined 3D geometries, such as the one we considered here, do obey laws in q2D (e.g.\ dipolar interactions).
          However, the interaction is too weak to produce the dynamics observed within the time scale of the experiment.
          In other words, it can only be used as a far-field approximation in the long-time limit.\medskip 
          \only<2->{
          \item The correct explanation for the experimental observation is based on a number of 3D effects,
            ...
            In practice, we may have to do a full simulation for each setup to predict the droplet dynamics,
      ...
      \only<3->{
        \begin{bluecolorbox}[Photonic material fabrication]
          ...
          \item It's still possible to make PhC using the microfluidic-based approach --
            an ingeneous approach is proposed to assemble face-centered cubic composed of smaller clusters.%
            \footnote<2->[frame]{Morozov \& Leshansky, Langmuir. 35, 11, 3987-3991 (2019).}\medskip 
            \only<4->{
            \item However, instead of struggling with crystal making, currently there is a strong trend in making disordered photonic materials.%
