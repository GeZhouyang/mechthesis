...
See \cite{Beatus2006, Janssen2012, Uspal2013} for analogous and more vivid demonstrations.
...
significant progress of physical understandings of spatial confinement on hydrodynamic interactions in the last two decades \citep{Cui_etal_2002, Cui2004, Diamant_2005, tlusty, Davit_2008}

start from the lubrication approximation.
show some dimensional analyses.
q2D.

going back to point forcing. far-field approximations.
heuristic arguments based on conservation laws \citep{Diamant}.
dipolar interaction, his eq. (8). very small prefactor. 
\begin{equation}
 \begin{aligned}
...
soap film \citep{Leonardo_etal_2008, Diamant}
\begin{equation}
 \begin{aligned}
...
\begin{figure}%[t]
  ...
  \caption{Flow fields due a moving particle in a Hele-Shaw channel (left) and in a soap film (right). Both systems are appoximately quasi-two-dimensional.}
  \label{fig:q2d}
\end{figure}
