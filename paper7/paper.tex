...
%
\papertitle[Note of HLGD for dense suspensions] % Short title used in healines (optional)
{%
 Implementation note on a minimal hybrid lubrication/granular dynamics model\\for dense suspensions% THE COMMENT SYMBOL AT THE END OF THIS LINE IS NEEDED
}%
%
\papertoctitle{Implementation note on a minimal hybrid lubrication/\\granular dynamics model for dense suspensions} % Title for toc
%
