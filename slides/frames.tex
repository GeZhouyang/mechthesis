...
\begin{frame}
  ...
  \emph{Photonic crystals} (PhC) are materials patterned with a \xg{periodicity in dielectric constant}
  and show great potential for building sophisticated optical circuitry that can
  \xo{route, filter, store} or \xo{suppress} optical signals.
...
\begin{frame}
  ...
  \begin{figure}
    ...
    \caption{(a) A diamond cubic (view angle 111).
      ...
      and the obtained cluster may serve as basic \xg{building blocks} for more complex structures.
...
\begin{frame}
  ...
  \begin{figure}
    ...
    \caption{
      (a) Self-assembly of two to four droplets in a \xg{microfluidic} chip; scale bars, 100 $\mu$m.
...
\begin{frame}
  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.45\textwidth}
      \centering
      \only<1,2,3,5,6>{\includegraphics[height=4cm]{imgs/espci-chip-cartoon.png}}
      \only<1,2,3>{\vskip.3cm \includegraphics[height=1.8cm]{imgs/espci-pancake.png}}
...
\begin{frame}
  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.55\textwidth}
      \begin{bluecolorbox}[Mathematical formulations]
