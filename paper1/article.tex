...
\Ge{As introduced earlier, colloidal droplets transported in microfluidic devices are subject to various forces, a typical of which is the depletion force. The depletion force arises from the exclusion of the surfactant micelles in the colloidal suspension. It is often characterised as a near-field attracting potential \citep{Asakura_1958, Mewis_colloidal}, and plays a key role in the droplet dynamics \citep{Shen_AS_2016, Shen_thesis}.}
...
Provided a hydrodynamic model for the depletion force between two droplets, we can easily generalise it to multiple droplets using the MLS.
