...
%-------------------------------------------------------------------------------
%
\title[On droplet interactions and suspension flows]% Title used in the abstract (optional)
{% Title of the thesis
	On Droplet Interactions and Suspension Flows
}%
...
{%	Author's affiliation
	Linn\'e FLOW Centre, Department of Mechanics\\KTH Royal Institute of Technology\\
...
{% Author's swedish affiliation (for swedish abstract)
	Linn\'e FLOW Centre, Institutionen f\"or Mekanik\\Kungliga Tekniska H\"ogskolan\\
