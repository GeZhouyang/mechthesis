...
Moreover, since contact interactions dominate at high particle concentrations,
we expect the present methodology to be applicable for the jamming and rheology of non-spherical particles or foams as well.

Finally, we include two miscellaneous studies concerning
the effective slip and robustness of liquid-infused surfaces and droplets statistics in a homogeneous turbulent shear flow.
...
facilitating experimental and theoretical investigations to design more robust drag-reducing surfaces and predict droplet emulsification.
...
%
\nyckelord{droppar, utarmningskraft, suspension, flerfasflöde, mikrofluidik, mjukt material, reologi, nivåuppsättning, spökvätska, diskret element.}
%
\end{abstrakt}
