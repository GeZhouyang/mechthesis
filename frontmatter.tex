...
%
\dedication{
	{\it If the scientist had an infinity of time at their disposal, it would be sufficient to say to them, ``Look, and look carefully.''}\\[20pt]
	Henri Poincar\'e
}
...
\begin{preface}
	This thesis summarizes a selection of studies on droplet interactions and suspension flows
        that may find applications in microfluidics, rheology, and soft matter physics.
        A brief introduction of some basic physical concepts and numerical methods is presented in Part I,
...
\begin{divisionofwork}
	...
	\paperitem
                LB led the research.
		ZG developed and implemented the method, with inputs from OT.
                ZG wrote the paper.
